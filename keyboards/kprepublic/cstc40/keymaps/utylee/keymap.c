...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * `-----------------------------------------------------------------------------------'
     */
	// 이게 원래였으나 Z 펑션 레이어를 추가하고 이건 비활성화하기로 했습니다
    /* [_ABLETON] = LAYOUT_planck_mit(KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, */ 
    ...
    */
    ...
    [_NUM] = LAYOUT_planck_mit(
			KC_PSCR, KC_7, KC_8, KC_9, KC_0, KC_ASTR, WOW, KC_7, KC_8, KC_9, KC_0, KC_BSPC, 
			/* KC_CAPS, KC_4, KC_5, KC_6, KC_PLUS, KC_MINUS, KC_SPC, KC_4, KC_5, KC_6, KC_PLUS, KC_ENT, */
			KC_SPC, KC_4, KC_5, KC_6, KC_SPC, QWERTY, KC_MINUS, KC_4, KC_5, KC_6, KC_PLUS, KC_ENT,
		   	KC_SPC, KC_1, KC_2, KC_3, XXXXXXX, KC_SPC, KC_EQL, KC_1, KC_2, KC_3, KC_MUTE, KC_MUTE, 
		   	/* KC_SPC, KC_1, KC_2, KC_3, KC_SPC, KC_SPC, KC_EQL, KC_1, KC_2, KC_3, KC_SPC, KC_SPC, */ 
			/* XXXXXXX, KC_MPLY, KC_MPRV, KC_MNXT, XXXXXXX, XXXXXXX, KC_0, KC_MUTE, KC_VOLD, KC_VOLU, XXXXXXX), */
			XXXXXXX, KC_MPLY, KC_MPRV, KC_MNXT, XXXXXXX, XXXXXXX, KC_0, XXXXXXX, KC_VOLD, KC_VOLU, KC_MUTE),
    ...
    [_SPACE_FN2_WOW] = LAYOUT_planck_mit(XXXXXXX, KC_F1, KC_F2, KC_F3, KC_F4, WOW, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END, _______, 
		KC_ENTER, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, QWERTY, MAC, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, _______, 
		XXXXXXX, WOW, WOW, _______, QWERTY, MAC, KC_INS, KC_DEL, KC_DEL, KC_INS, KC_INS, XXXXXXX,
		KC_CAPS, KC_CAPS, _______, _______, _______, XXXXXXX, XXXXXXX, KC_MUTE, KC_VOLD, KC_VOLU, XXXXXXX),
...
/*         case SPACE_FN2: */
/*             return true; */
/*         /1* 오른손 모드 키들은 tapping_force_hold를 적용하지 않습니다. *1/ */
/*         case LCTL_T(KC_J): */
/*             return false; */
/*         case RGUI_T(KC_K): */
/*             return false; */
...
// 모드 키를 연속 누를 때 모드 기능이 꺼지고 반복모드가 되게하는 옵션입니다
// tapping_force_hold 에서 이름이 변경되었다고 합니다
